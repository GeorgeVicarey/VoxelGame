...
void Cube::createCube() {
	...
	float vertices[] = {
		//X,    Y,     Z,    R,    G,    B
//		-0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 1.0f,		// 0 == 16 == 10
//		 0.5f, -0.5f, -0.5f, 0.0f, 0.0f, 1.0f,		// 1 == 14 == 17
//		 0.5f,  0.5f, -0.5f, 1.0f, 1.0f, 0.0f,		// 2 == 13 == 21
//		-0.5f,  0.5f, -0.5f, 1.0f, 0.0f, 0.0f,		// 3 == 9 == 20
//
//		-0.5f, -0.5f,  0.5f, 1.0f, 0.0f, 1.0f,		// 4 == 11 == 19
//		 0.5f, -0.5f,  0.5f, 0.0f, 0.0f, 1.0f,		// 5 == 15 == 18
//		 0.5f,  0.5f,  0.5f, 1.0f, 1.0f, 0.0f, 		// 6 == 22 ==12
//		-0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 0.0f,		// 7 == 8 == 23
//
//		-0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 1.0f,		// 8 == 7 == 23
//		-0.5f,  0.5f, -0.5f, 0.0f, 0.0f, 1.0f,		// 9 == 3 == 20
//		-0.5f, -0.5f, -0.5f, 1.0f, 1.0f, 0.0f,		// 10 == 0 == 16
//		-0.5f, -0.5f,  0.5f, 1.0f, 0.0f, 0.0f,		// 11 == 4 == 19
//
//	     0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 1.0f,		// 12 == 6 == 22
//	     0.5f,  0.5f, -0.5f, 0.0f, 0.0f, 1.0f,		// 13 == 2 == 21
//	     0.5f, -0.5f, -0.5f, 1.0f, 1.0f, 0.0f,		// 14 == 1 == 17
//	     0.5f, -0.5f,  0.5f, 1.0f, 0.0f, 0.0f,		// 15 == 5 == 18
//
//	    -0.5f, -0.5f, -0.5f, 1.0f, 0.0f, 1.0f,		// 16 == 0 == 10
//	     0.5f, -0.5f, -0.5f, 0.0f, 0.0f, 1.0f,		// 17== 14 == 1
//	     0.5f, -0.5f,  0.5f, 1.0f, 1.0f, 0.0f,		// 18 == 5 == 15
//	    -0.5f, -0.5f,  0.5f, 1.0f, 0.0f, 0.0f,		// 19 == 4 == 11
//
//	    -0.5f,  0.5f, -0.5f, 1.0f, 0.0f, 1.0f,		// 20 == 3 == 9
//	     0.5f,  0.5f, -0.5f, 0.0f, 0.0f, 1.0f,		// 21 == 2 == 13
//	     0.5f,  0.5f,  0.5f, 1.0f, 1.0f, 0.0f,		// 22 == 6 == 12
//	    -0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 0.0f		// 23 == 7 == 8
